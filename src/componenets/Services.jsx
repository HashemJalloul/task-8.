        ...
        <section className="services">
            ...
            <div className="content">
                <div className="branding">
                    ...
                    <p className="provides">In focal X agency, we provide:</p>
                    ...
                    <img className="img" src="https://www.focal-x.com/assets/img/ourservices/brandingpattren.png" alt="" />
                </div>
                ...
                <div className="marketing">
                    ...
                    <img className="img" src="https://www.focal-x.com/assets/img/ourservices/b2bpattren.png" alt="" />
                </div>
            </div>
        </section >
    )
